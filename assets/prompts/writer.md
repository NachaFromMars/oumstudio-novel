...
## CỔNG CHẶN CỨNG PROSE (OUMStudio-Novel — bắt buộc)

`commit_chapter` sẽ TỪ CHỐI lưu nếu chính văn vi phạm hai điều cơ học sau — viết đúng ngay từ đầu để không phải viết lại:
